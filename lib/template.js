...
module.exports = {
  ...
  movie_detail:function(movie){
    ...
    body = body + `
                  <div class="container">
                    ...
                    <div style="display: inline-block; padding-left:30px; padding-top:30px;">
  ...
  genre_select_list:function(genres){
    ...
    while(i < genres.length){
      list = list + `<label class="control control--checkbox"><input type="checkbox" name="genre" value="${genres[i].G_ID}">${genres[i].G_Category}<div class="control__indicator"></div></label>
      <style>
      .control__indicator {
        position: absolute;
        top: 2px;
